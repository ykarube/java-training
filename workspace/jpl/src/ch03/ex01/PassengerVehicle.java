...
public class PassengerVehicle extends Vehicle {
	 ...
	 * @in seatNum 座席の数
	 */
	public PassengerVehicle(String owner, long myID, int seatNum ) {
		super(owner, myID);
...
//--------------------------------------------------------------------------------------------//
	public static void main(String[] args) {
		PassengerVehicle kei = new PassengerVehicle("kei_owner", 001, 4);
		PassengerVehicle normal = new PassengerVehicle("normal_owner", 002, 5);
		PassengerVehicle wagon = new PassengerVehicle("wagon_owner", 003, 8);
